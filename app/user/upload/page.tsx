    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Upload your meeting recording to generate AI-powered transcripts and summaries
        </p>
      </div>
            ...
            {uploadFiles.map((uploadFile) => (
              <div key={uploadFile.id} className="border rounded-lg p-4">
                ...
                <div className="space-y-2">
                  ...
                  <Progress 
                    value={uploadFile.status === 'uploading' ? uploadFile.progress : 100} 
                    className="h-2"
                  />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <Label htmlFor="transcript" className="font-medium">Generate Transcript</Label>
              </div>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-4 border rounded-lg">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <Label htmlFor="summary" className="font-medium">AI Summary</Label>
              </div>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-4 border rounded-lg">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <Label htmlFor="highlights" className="font-medium">Extract Highlights</Label>
              </div>
              <p className="text-sm text-gray-600">
