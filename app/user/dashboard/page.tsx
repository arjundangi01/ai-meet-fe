        ...
        <Card className="border-blue-200 bg-blue-50">
          ...
          <CardContent>
            <p className="text-blue-800 mb-3">
              {processingMeetings} meeting{processingMeetings > 1 ? 's' : ''} currently being processed by AI
            </p>
            <Progress value={75} className="h-2" />
            <p className="text-sm text-blue-600 mt-2">Estimated completion: 5 minutes</p>
          </CardContent>
        </Card>
      )}
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            ...
            <CardContent>
              <p className="text-sm text-blue-800">
                Upload meetings right after they end to get the most accurate transcriptions and summaries!
              </p>
            </CardContent>
          </Card>
        </div>
