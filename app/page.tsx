...
const features = [
  {
    ...
    description: 'Get accurate transcripts of your meetings with 99% accuracy using advanced AI technology.'
  },
  {
    icon: <FileText className="h-8 w-8" />,
    title: 'Smart Summaries',
    description: 'Automatically generate concise summaries with key decisions and action items.'
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: 'Key Highlights',
    description: 'Extract important moments and insights from your meetings instantly.'
  },
  {
    icon: <Search className="h-8 w-8" />,
    title: 'Searchable Archive',
    description: 'Find any meeting content quickly with powerful search across all your recordings.'
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: 'Team Collaboration',
    description: 'Share meeting insights and collaborate on action items with your team.'
  },
  {
...
const testimonials = [
  {
    ...
    role: 'VP of Product',
    company: 'TechCorp',
    content: 'This tool has revolutionized how we handle meetings. No more manual note-taking!',
  ...
  },
  {
    ...
    company: 'StartupXYZ',
    content: 'The AI summaries are incredibly accurate. Saves us hours every week.',
  ...
  },
  {
    ...
    company: 'ScaleUp Inc',
    content: 'Perfect for keeping track of decisions and ensuring nothing falls through the cracks.',
          ...
          <div className="text-center">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl lg:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                summaries, and highlights. Never miss important details again.
              </p>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg">
                  ...
                  <div className="text-left space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-gray-600">AI Summary Generated</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful AI features to transform how your team collaborates and makes decisions
            </p>
          </div>
